...
exchangeRate: “سعر الدولار”, saveRate: “حفظ”, convertTo: “تحويل إلى”, fromUSD: “دينار ← دولار”, fromIQD: “دولار ← دينار”,
...
```
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    // parse date formats like 1/3/2026 or 28/2/2026
    if (dateVal) {
...
// ==================== LOANS (with persons + choose list) ====================
...
// ==================== CONCRETE (with IQD/USD + received status) ====================
...
// ==================== CONTRACTOR (with persons + choose list) ====================
