        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
          {["A3", "A4", "A5"].map(sz => (
            <button key={sz} onClick={() => onSelect(sz)} style={{ padding: "12px 28px", borderRadius: 8, border: `2px solid ${PRIMARY}`, background: "transparent", color: PRIMARY, fontSize: 15, fontWeight: 700, cursor: "pointer", transition: "all 0.2s" }}
              ...
              onMouseLeave={e => { e.target.style.background = "transparent"; e.target.style.color = PRIMARY; }}>{sz}</button>
          ))}
        </div>
      </div>
    </div>
...
export default function App() {
  ...
  const shared = { 
    ...
    exchangeRate, setExchangeRate, cashLog, setCashLog, addCashLog 
  };
    ...
    <div dir={isRtl ? "rtl" : "ltr"} style={{ background: "#fff", color: "#1c1917", fontFamily, minHeight: "100vh" }}>
      <nav style={{ 
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div className="dnav" style={{ display: "flex", alignItems: "center", gap: 20 }}>
            {["home", "services", "about", "contact"].map(x => (
              <button 
                ...
                onClick={() => scrollTo(x)} 
                style={{ 
                  background: "none", border: "none", color: "#1c1917", cursor: "pointer", 
                  fontSize: 13, fontWeight: 500, fontFamily, padding: "3px 0", 
                  borderBottom: "2px solid transparent", transition: "all 0.3s" 
                }} 
                onMouseEnter={e => e.target.style.borderBottomColor = PRIMARY} 
            ...
            <select 
              ...
              style={{ 
                ...
                borderRadius: 6, padding: "4px 8px", fontSize: 11, cursor: "pointer", fontFamily 
              }}
            >
          ...
          <button 
            ...
            style={{ display: "none", background: "none", border: "none", color: "#1c1917", cursor: "pointer" }}
          >
        ...
        {mobileMenu && (
          <div style={{ 
            ...
            background: "rgba(255,255,255,0.98)", padding: 16, 
            ...
            {["home", "services", "about", "contact"].map(x => (
              <button 
                ...
                style={{ 
                  background: "none", border: "none", color: "#1c1917", cursor: "pointer", 
                  fontSize: 14, textAlign: isRtl ? "right" : "left", padding: "5px 0", fontFamily 
                }}
              >
                {t.nav[x]}
              </button>
            ...
            <select 
              ...
              style={{ 
                ...
                borderRadius: 6, padding: "6px 10px", fontSize: 13, fontFamily 
              }}
            >
              <option value="ku">کوردی</option>
              <option value="en">English</option>
      ...
      <section id="home" style={{ paddingTop: 80 }}>
            ...
            {PROJECT_IMAGES.map((img, i) => (
              <div key={i} style={{ position: "relative" }}>
                <div 
                  ...
                  style={{ borderRadius: 10, overflow: "hidden", cursor: "pointer", aspectRatio: "16/9" }}
                >
                  <img 
                    src={img.src} 
                    alt="" 
                ...
                <p style={{ textAlign: "right", fontSize: 12, color: "#78716c", marginTop: 4, fontWeight: 600, fontFamily }}>
                  {img[`desc_${lang}`]}
                </p>
              </div>
            ))}
        ...
        <div style={{ textAlign: "right", padding: "50px 20px 70px" }}>
          ...
          <h1 style={{ fontSize: "clamp(28px,5vw,50px)", fontWeight: 900, color: PRIMARY, marginBottom: 16, fontFamily }}>
            {t.hero.title}
          </h1>
          <p style={{ fontSize: "clamp(14px,2vw,17px)", color: "#78716c", lineHeight: 1.7, maxWidth: 560, margin: "0 auto 30px", fontFamily }}>
            {t.hero.subtitle}
          </p>
          <button 
            ...
            style={{ 
              ...
              boxShadow: `0 4px 20px ${PRIMARY}40`, fontFamily 
            }}
          >
            {t.hero.cta}
          </button>
      ...
      <section id="services" style={{ padding: "70px 20px", maxWidth: 1200, margin: "0 auto" }}>
        <h2 style={{ textAlign: "right", fontSize: 28, fontWeight: 800, marginBottom: 40, color: PRIMARY, fontFamily }}>
          {t.services.title}
        </h2>
          ...
          {[t.services.s1, t.services.s2, t.services.s3].map((sv, i) => (
            <div 
              ...
              style={{ 
                ...
                padding: 28, borderTop: `3px solid ${PRIMARY}`, transition: "transform 0.3s" 
              }} 
      ...
      <section id="about" style={{ padding: "70px 20px", background: "#f9fafb" }}>
        <div style={{ maxWidth: 750, margin: "0 auto" }}>
          <h2 style={{ textAlign: "right", fontSize: 28, fontWeight: 800, marginBottom: 36, color: PRIMARY, fontFamily }}>
            {t.about.title}
          </h2>
            ...
            {t.about.items.map((item, i) => (
              <div 
                ...
                style={{ 
                  ...
                  padding: "16px 14px", display: "flex", gap: 8, alignItems: "flex-start" 
                }}
              >
      ...
      <section id="contact" style={{ padding: "70px 20px" }}>
        <div style={{ maxWidth: 500, margin: "0 auto", textAlign: "right" }}>
          <h2 style={{ fontSize: 28, fontWeight: 800, marginBottom: 36, color: PRIMARY, fontFamily }}>
            {t.contact.title}
          </h2>
            ...
            {[
              ...
              <a 
                ...
                style={{ 
                  ...
                  background: "#fff", border: "1px solid #e5e5e5", borderRadius: 8, 
                  textDecoration: "none", color: "#1c1917", direction: "ltr", 
                  transition: "border-color 0.3s", fontFamily 
                }} 
      ...
      {lightbox && (
        <div 
          ...
          style={{ 
            ...
            display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", padding: 16 
          }}
        >
          <img 
            src={lightbox} 
    ...
    <div dir={isRtl ? "rtl" : "ltr"} style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f9fafb", fontFamily, padding: 20 }}>
      <div style={{ background: "#fff", border: "1px solid #e5e5e5", borderRadius: 16, padding: 40, width: "100%", maxWidth: 360, boxShadow: "0 8px 32px rgba(0,0,0,0.06)" }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <Logo size={50} />
          <h2 style={{ color: PRIMARY, marginTop: 12, fontSize: 20, fontWeight: 800 }}>{t.login}</h2>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            <label style={{ fontSize: 11, color: "#78716c", fontWeight: 600 }}>{t.username}</label>
            <input 
              value={u} 
              onChange={e => { setU(e.target.value); setErr(false); }} 
              style={{ 
                width: "100%", padding: "10px 14px", borderRadius: 8, 
                border: `1px solid ${err ? "#EF4444" : "#e5e5e5"}`, 
                background: "#f8f8f8", color: "#333", fontSize: 13, outline: "none", 
                direction: "ltr", marginTop: 3 
              }} 
            />
          </div>
          <div>
            <label style={{ fontSize: 11, color: "#78716c", fontWeight: 600 }}>{t.password}</label>
            <input 
              type="password" 
              value={p} 
              onChange={e => { setP(e.target.value); setErr(false); }} 
              onKeyDown={e => e.key === "Enter" && (onLogin(u, p) || setErr(true))} 
              style={{ 
                width: "100%", padding: "10px 14px", borderRadius: 8, 
                border: `1px solid ${err ? "#EF4444" : "#e5e5e5"}`, 
                background: "#f8f8f8", color: "#333", fontSize: 13, outline: "none", 
          ...
          <button 
            ...
            style={{ 
              background: PRIMARY, color: "#fff", border: "none", borderRadius: 8, 
              padding: "10px", fontSize: 14, fontWeight: 700, cursor: "pointer", marginTop: 4 
            }}
          >
            {t.enter}
          </button>
          <button 
            onClick={onBack} 
            style={{ background: "none", border: "none", color: "#78716c", cursor: "pointer", fontSize: 12 }}
          >
            ← {t.nav.home}
          </button>
        </div>
...
function Dashboard({ t, s, isRtl, dark, lang, fontFamily, pKey, user, dashPage, setDashPage, onLogout, cashIQD, setCashIQD, cashUSD, setCashUSD, exchangeRate, setExchangeRate, cashLog, setCashLog, addCashLog, setDark, setLang, fontIdx, setFontIdx }) {
  ...
  return (
    <div dir={isRtl ? "rtl" : "ltr"} style={{ display: "flex", minHeight: "100vh", background: s.bg, fontFamily, color: s.text }}>
      <aside style={{ 
        width: 240, minWidth: 240, background: dark ? "#141414" : "#fff", 
        borderRight: isRtl ? "none" : `1px solid ${s.border}`, 
        borderLeft: isRtl ? `1px solid ${s.border}` : "none", 
        display: "flex", flexDirection: "column", position: "fixed", 
        top: 0, bottom: 0, [isRtl ? "right" : "left"]: 0, zIndex: 100, overflowY: "auto" 
      }}>
        <div style={{ 
          padding: "14px 12px", borderBottom: `1px solid ${s.border}`, 
          display: "flex", alignItems: "center", gap: 7 
        }}>
          <Logo size={28} />
          <div>
            <div style={{ fontWeight: 800, color: PRIMARY, fontSize: 13 }}>KARO GROUP</div>
            <div style={{ fontSize: 9, color: s.textMuted }}>{user.label || user.project}</div>
          </div>
        </div>
        <div style={{ 
          padding: "10px 12px", borderBottom: `1px solid ${s.border}`, 
          background: dark ? "#0d0d0d" : `${PRIMARY}06` 
        }}>
          <div style={{ fontSize: 9, fontWeight: 700, color: s.textMuted, marginBottom: 5 }}>{t.cashBox}</div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, marginBottom: 2 }}>
            <span>{t.iqd}:</span>
            <span style={{ fontWeight: 700, color: cashIQD >= 0 ? s.success : s.danger }}>{fmt(cashIQD)}</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11 }}>
            <span>{t.usd}:</span>
            <span style={{ fontWeight: 700, color: cashUSD >= 0 ? s.success : s.danger }}>${fmt(cashUSD)}</span>
          </div>
        </div>
          ...
          {items.map(p => (
            <button 
              ...
              style={{ 
                ...
                color: dashPage === p.id ? PRIMARY : s.text, cursor: "pointer", 
                fontSize: 12, fontWeight: dashPage === p.id ? 700 : 500, 
                textAlign: isRtl ? "right" : "left", marginBottom: 1 
              }}
            >
              {typeof p.icon === "string" ? <span style={{ fontSize: 14 }}>{p.icon}</span> : <span style={{ color: dashPage === p.id ? PRIMARY : s.textMuted }}>{p.icon}</span>}
              {p.label}
            </button>
          ))}
          <button 
            ...
            style={{ 
              display: "flex", alignItems: "center", gap: 8, width: "100%", 
              padding: "8px 10px", borderRadius: 7, border: "none", 
              background: "transparent", color: s.danger, cursor: "pointer", 
              fontSize: 12, fontWeight: 500, textAlign: isRtl ? "right" : "left", marginTop: 4 
            }}
          >
        ...
        <div style={{ 
          padding: "8px 10px", borderTop: `1px solid ${s.border}`, 
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <select 
              ...
              style={{ 
                flex: 1, background: s.bgCard2, color: s.text, 
          ...
          <button 
            ...
            style={{ 
              ...
              padding: "6px 8px", borderRadius: 5, border: `1px solid ${s.border}`, 
              background: s.bgCard2, color: s.text, cursor: "pointer", fontSize: 11 
            }}
          >
      ...
      <main style={{ 
        flex: 1, [isRtl ? "marginRight" : "marginLeft"]: 240, 
        padding: 16, minHeight: "100vh", width: "calc(100vw - 240px)" 
      }}>
      ...
      {formatModal && (
        <div style={{ 
          ...
          <div style={{ 
            background: s.bgCard, borderRadius: 14, padding: 28, 
            maxWidth: 340, width: "100%", textAlign: "right" 
          }}>
            ...
            <input 
              ...
              style={{ 
                ...
                border: `1px solid ${s.border}`, background: s.bgCard2, 
                color: s.text, fontSize: 12, marginBottom: 8, direction: "ltr" 
              }} 
            />
            <input 
              type="password" 
              ...
              style={{ 
                width: "100%", padding: "8px 12px", borderRadius: 6, 
                border: `1px solid ${s.border}`, background: s.bgCard2, 
                color: s.text, fontSize: 12, marginBottom: 14, direction: "ltr" 
              }} 
            />
      ...
      <style>{`
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        @media(max-width:768px){
          ...
          main{margin-left:190px!important;margin-right:190px!important;width:calc(100vw - 190px)!important}
        }
      `}</style>
    </div>
  );
        ...
        {cards.map((c, i) => (
          <div 
            ...
            style={{ 
              ...
              padding: 16, borderTop: `3px solid ${c.c}`, textAlign: "center" 
            }}
          >
            ...
            <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
              ...
              <div 
                style={{ 
                  ...
                  height: `${Math.max((d.val / maxVal) * 160, 4)}px`, 
                  background: `linear-gradient(180deg, ${d.c}, ${d.c}90)`, 
  ...
  return (
    <div>
        ...
        <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
          <label 
            style={{ 
              ...
              background: s.bgCard2, cursor: "pointer", fontSize: 11, color: s.text 
            }}
          >
            <I.Upload /> {t.importExcel}
            <input type="file" accept=".csv,.txt" onChange={handleImportExcel} style={{ display: "none" }} />
          </label>
          <button 
            onClick={() => setSizeModal({ type: "pdf" })} 
            style={{ 
              padding: "6px 12px", borderRadius: 6, border: `1px solid ${s.border}`, 
              background: s.bgCard2, color: s.text, cursor: "pointer", 
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 10, flexWrap: "wrap" }}>
        <div style={{ background: `${PRIMARY}10`, borderRadius: 8, padding: "6px 14px", fontSize: 12 }}>
      ...
      <div 
        style={{ 
          background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 10, 
          padding: 10, marginBottom: 10, display: "flex", gap: 8, 
          flexWrap: "wrap", alignItems: "flex-end" 
        }}
      >
        <div style={{ flex: 1, minWidth: 140 }}>
          <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.search}</label>
          <input 
            value={search} 
        ...
        <div>
          <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.filterMonth}</label>
          <select 
            value={filterMonth} 
            onChange={e => setFilterMonth(e.target.value)} 
            style={{ 
              padding: "6px 10px", borderRadius: 6, border: `1px solid ${s.border}`, 
              background: s.bgCard2, color: s.text, fontSize: 12 
            }}
          >
        ...
        {showMarkedOnly ? (
          <button 
            onClick={() => { 
              ...
              setItems(prev => prev.map(i => ({ ...i, marked: false }))); 
            }} 
            style={{ 
              padding: "6px 12px", borderRadius: 6, border: "none", 
              background: "#D1FAE5", color: "#059669", fontSize: 11, 
          ...
          <button 
            ...
            style={{ 
              padding: "6px 12px", borderRadius: 6, border: `1px solid ${s.border}`, 
              background: s.bgCard2, color: s.text, fontSize: 11, cursor: "pointer" 
            }}
          >
            {t.showMarked}
          </button>
      ...
      {showForm && (
        <div 
          style={{ 
            background: s.bgCard, border: `1px solid ${PRIMARY}40`, 
        ...
        >
          ...
          >
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.amountIQD}</label>
              <input 
                type="number" 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.amountUSD}</label>
              <input 
                type="number" 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.receiptNo}</label>
              <input 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.note}</label>
              <input 
                value={form.note} 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.date}</label>
              <input 
                type="date" 
                value={form.date} 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.receiptImg}</label>
              <label 
                style={{ 
                  display: "flex", alignItems: "center", gap: 4, 
                  padding: "6px 10px", borderRadius: 6, border: `1px dashed ${s.border}`, 
                  background: s.bgCard2, cursor: "pointer", fontSize: 11, color: s.textMuted 
                }}
              >
              ...
              {form.receiptImg && (
                <div style={{ display: "flex", gap: 4, alignItems: "center", marginTop: 3 }}>
                  <img src={form.receiptImg} alt="" style={{ width: 32, height: 32, objectFit: "cover", borderRadius: 3 }} />
                  <button 
                  ...
                  <TD s={s} isRtl={isRtl}>
                    {item.receiptImg ? (
                      <img 
                        src={item.receiptImg} 
                        alt="" 
                        style={{ width: 24, height: 24, objectFit: "cover", borderRadius: 3, cursor: "pointer" }} 
                  ...
                  <TD s={s} isRtl={isRtl}>
                    <div style={{ display: "flex", gap: 3 }}>
                      <button 
                        ...
                        style={{ background: "none", border: "none", color: PRIMARY, cursor: "pointer", padding: 2 }}
                      >
                        <I.Edit />
                      </button>
                      <button 
      ...
      {imgPreview && (
        ...
        >
          <img src={imgPreview} alt="" style={{ maxWidth: "90%", maxHeight: "90vh", borderRadius: 6 }} />
        </div>
      )}
    </div>
  );
      ...
      <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 10, padding: 10, marginBottom: 10 }}>
        <div style={{ display: "flex", gap: 6, alignItems: "center", marginBottom: 8, flexWrap: "wrap" }}>
          <input 
            ...
            style={{ 
              padding: "6px 10px", borderRadius: 6, border: `1px solid ${s.border}`, 
              background: s.bgCard2, color: s.text, fontSize: 12, width: 160 
            }} 
          />
          <button 
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
          <button 
            ...
            style={{ 
              ...
              border: !selectedPerson ? `2px solid ${PRIMARY}` : `1px solid ${s.border}`, 
              background: !selectedPerson ? `${PRIMARY}15` : "transparent", 
              color: !selectedPerson ? PRIMARY : s.text, cursor: "pointer", 
              fontSize: 11, fontWeight: 600 
            }}
          >
            {t.allPersons}
          ...
          {personsList.map(p => (
            <button 
              ...
              style={{ 
                padding: "5px 12px", borderRadius: 20, 
                border: selectedPerson === p ? `2px solid ${PRIMARY}` : `1px solid ${s.border}`, 
                background: selectedPerson === p ? `${PRIMARY}15` : "transparent", 
                color: selectedPerson === p ? PRIMARY : s.text, cursor: "pointer", 
                fontSize: 11, fontWeight: 600 
              }}
            >
              {p}
          ...
          {showMarkedOnly ? (
            <button 
              onClick={() => { setShowMarkedOnly(false); setItems(prev => prev.map(i => ({ ...i, marked: false }))); }} 
              style={{ 
            ...
            <button 
              onClick={() => setShowMarkedOnly(true)} 
              style={{ 
                padding: "5px 12px", borderRadius: 20, border: `1px solid ${s.border}`, 
                background: s.bgCard2, color: s.text, fontSize: 11, cursor: "pointer" 
              }}
            >
              {t.showMarked}
      ...
      {showForm && (
        <div style={{ background: s.bgCard, border: `1px solid ${PRIMARY}40`, borderRadius: 10, padding: 14, marginBottom: 10 }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 8 }}>
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.loanType}</label>
              <select 
                value={form.type} 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.personName}</label>
              <select 
                  ...
                  <TD s={s} isRtl={isRtl}>
                    <span 
                      style={{ 
                        ...
                        background: item.type === "take" ? "#D1FAE5" : "#FEE2E2", 
                        color: item.type === "take" ? "#059669" : "#EF4444" 
                      }}
                    >
      ...
      {showForm && (
        <div style={{ background: s.bgCard, border: `1px solid ${PRIMARY}40`, borderRadius: 10, padding: 14, marginBottom: 10 }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 8 }}>
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.concCurrency}</label>
              <select 
                value={form.currency} 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.meters}</label>
              <input 
                type="number" 
                value={form.meters} 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.pricePerMeter}</label>
              <input 
                type="number" 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.totalConcrete}</label>
              <div 
                style={{ 
                  padding: "6px 10px", borderRadius: 6, background: `${PRIMARY}10`, 
                  fontWeight: 700, color: PRIMARY, fontSize: 12 
                }}
              >
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.depositPercent}</label>
              <input 
                type="number" 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.deposit}</label>
              <div 
                style={{ 
                  padding: "6px 10px", borderRadius: 6, background: "#FEF3C7", 
                  fontWeight: 700, color: "#D97706", fontSize: 12 
                }}
              >
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.received}</label>
              <div 
                style={{ 
                  padding: "6px 10px", borderRadius: 6, background: "#D1FAE5", 
                  fontWeight: 700, color: "#059669", fontSize: 12 
                }}
              >
                    ...
                    <TD s={s} isRtl={isRtl}>
                      {item.isReceived ? (
                        ...
                        <button 
                          ...
                          style={{ 
                            padding: "3px 8px", borderRadius: 4, border: `1px solid ${s.success}`, 
                    ...
                    <TD s={s} isRtl={isRtl}>
                      <div style={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
                        {!item.depositClaimed && item.deposit > 0 && (
                          <button 
                            onClick={() => claimDeposit(item.id)} 
                            style={{ 
                              padding: "2px 6px", borderRadius: 4, border: `1px solid #D97706`, 
      ...
      {showForm && (
        <div style={{ background: s.bgCard, border: `1px solid ${PRIMARY}40`, borderRadius: 10, padding: 14, marginBottom: 10 }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 8 }}>
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.contractorType}</label>
              <select 
                value={form.type} 
                onChange={e => setForm({ ...form, type: e.target.value })} 
                style={{ 
                  ...
                  <TD s={s} isRtl={isRtl}>
                    <span 
                      style={{ 
                        ...
                        color: item.type === "add" ? "#059669" : "#EF4444" 
                      }}
                    >
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 12, marginBottom: 16 }}>
        <div 
          style={{ 
            background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 12, 
            padding: 16, textAlign: "center", cursor: "pointer", borderTop: `3px solid ${s.success}` 
          }} 
          onClick={() => { if (!editIQD) { setEditIQD(true); setTmpIQD(cashIQD); } }}
        >
          ...
          {editIQD ? (
            <div style={{ display: "flex", gap: 5, justifyContent: "center" }}>
              <input 
                type="number" 
                value={tmpIQD} 
                onChange={e => setTmpIQD(Number(e.target.value))} 
                style={{ 
                  width: 120, padding: "5px 8px", borderRadius: 5, 
                  border: `1px solid ${PRIMARY}`, background: s.bgCard2, 
                  color: s.text, fontSize: 15, textAlign: "center" 
                }} 
                autoFocus 
              />
              <button 
                onClick={e => { e.stopPropagation(); setCashIQD(tmpIQD); setEditIQD(false); }} 
                style={{ 
                  padding: "4px 10px", borderRadius: 5, background: PRIMARY, 
            ...
            <>
              <div style={{ fontSize: 22, fontWeight: 800, color: cashIQD >= 0 ? s.success : s.danger, direction: "ltr" }}>
                {fmt(cashIQD)}
              </div>
        ...
        <div 
          ...
          onClick={() => { if (!editUSD) { setEditUSD(true); setTmpUSD(cashUSD); } }}
        >
          ...
          {editUSD ? (
            <div style={{ display: "flex", gap: 5, justifyContent: "center" }}>
              <input 
                type="number" 
                value={tmpUSD} 
                onChange={e => setTmpUSD(Number(e.target.value))} 
                style={{ 
                  width: 120, padding: "5px 8px", borderRadius: 5, 
                  border: `1px solid ${PRIMARY}`, background: s.bgCard2, 
                  color: s.text, fontSize: 15, textAlign: "center" 
              ...
              />
              <button 
                onClick={e => { e.stopPropagation(); setCashUSD(tmpUSD); setEditUSD(false); }} 
                style={{ 
                  padding: "4px 10px", borderRadius: 5, background: PRIMARY, 
                  color: "#fff", border: "none", fontSize: 11, cursor: "pointer" 
                }}
            ...
            <>
              <div style={{ fontSize: 22, fontWeight: 800, color: cashUSD >= 0 ? s.success : s.danger, direction: "ltr" }}>
                ${fmt(cashUSD)}
              </div>
              <div style={{ fontSize: 9, color: s.textMuted, marginTop: 2 }}>{t.clickToChange}</div>
            </>
        ...
        <div 
          style={{ 
            background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 12, 
            padding: 16, textAlign: "center", borderTop: `3px solid ${PRIMARY}` 
          }}
        >
          <div style={{ fontSize: 10, color: s.textMuted, fontWeight: 600, marginBottom: 5 }}>{t.totalInIQD}</div>
          <div style={{ fontSize: 22, fontWeight: 800, color: PRIMARY, direction: "ltr" }}>
            {fmt(Math.round(cashIQD + cashUSD * exchangeRate))}
          </div>
      ...
      <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 10, overflow: "hidden" }}>
        ...
        <div style={{ overflowX: "auto", maxHeight: 400, overflowY: "auto" }}>
          <table style={tableStyle}>
            <thead>
              <tr>
                {[t.date, "", t.type, t.iqd, t.usd].map((h, i) => <TH key={i} isRtl={isRtl}>{h}</TH>)}
              </tr>
            </thead>
            <tbody>
              {[...cashLog].reverse().map(log => (
                <tr key={log.id}>
                  <TD s={s} isRtl={isRtl} style={{ fontSize: 10 }}>
                    <span style={{ direction: "ltr", display: "inline-block" }}>
                      {log.date}
                    </span>
                  </TD>
                  ...
                  <TD s={s} isRtl={isRtl} style={{ color: log.iqd >= 0 ? s.success : s.danger, fontWeight: 600 }}>
                    <span style={{ direction: "ltr", display: "inline-block" }}>
                      {log.iqd >= 0 ? "+" : ""}{fmt(log.iqd)}
                    </span>
                  </TD>
                  <TD s={s} isRtl={isRtl} style={{ color: log.usd >= 0 ? s.success : s.danger, fontWeight: 600 }}>
                    <span style={{ direction: "ltr", display: "inline-block" }}>
...
function ExchangePage({ t, s, isRtl, exchangeRate, setExchangeRate, cashIQD, setCashIQD, cashUSD, setCashUSD, addCashLog }) {
  ...
  const handleConvert = () => {
    ...
    if (dir === "usd_to_iqd") {
      ...
      setCashUSD(p => p - a);
      setCashIQD(p => p + Math.round(a * exchangeRate));
      addCashLog(`${t.convert}: $${a} → ${fmt(Math.round(a * exchangeRate))}`, Math.round(a * exchangeRate), -a);
    } else {
      if (a > cashIQD) { setAlert(t.noBalance); return; }
      setCashIQD(p => p - a);
      setCashUSD(p => p + Math.round(a / exchangeRate));
      addCashLog(`${t.convert}: ${fmt(a)} → $${Math.round(a / exchangeRate)}`, -a, Math.round(a / exchangeRate));
    }
    setAmt("");
  };
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 14 }}>
        <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 12, padding: 18 }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "flex-end" }}>
            <div style={{ flex: 1 }}>
              <label style={{ fontSize: 10, color: s.textMuted }}>1 USD =</label>
              <input 
                type="number" 
                value={tmpRate} 
            ...
            <button 
              onClick={() => setExchangeRate(tmpRate)} 
              style={{ 
                padding: "7px 14px", borderRadius: 6, background: PRIMARY, 
          ...
          <div style={{ marginTop: 8, padding: "8px 12px", background: `${PRIMARY}10`, borderRadius: 6, textAlign: "center" }}>
            <span style={{ fontSize: 16, fontWeight: 800, color: PRIMARY }}>1$ = {fmt(exchangeRate)} {t.iqd}</span>
          </div>
        </div>
        <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 12, padding: 18 }}>
          <h3 style={{ fontSize: 14, fontWeight: 700, marginBottom: 12 }}>{t.convert}</h3>
          <div>
            <label style={{ fontSize: 10, color: s.textMuted }}>{t.convertTo}</label>
            <select 
              value={dir} 
              ...
              style={{ 
                width: "100%", padding: "6px 10px", borderRadius: 6, 
                border: `1px solid ${s.border}`, background: s.bgCard2, 
                color: s.text, fontSize: 12, marginBottom: 8 
              }}
            >
          ...
          <div>
            <label style={{ fontSize: 10, color: s.textMuted }}>{t.amount}</label>
            <input 
              type="number" 
              value={amt} 
          ...
          <div style={{ padding: "10px", background: "#D1FAE5", borderRadius: 6, textAlign: "center", marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 800, color: "#059669", direction: "ltr" }}>
...
function InvoicePage({ t, s, isRtl, pKey }) {
  ...
  const printInv = inv => {
    ...
    w.document.write(`<html dir="${isRtl ? "rtl" : "ltr"}"><head><title>Invoice</title><style> 
      ...
      th{background:${PRIMARY};color:#fff;padding:6px}
      ...
      <table>
        <thead>
          <tr>
            ...
            <th>${t.price}</th>
            <th>${t.total}</th>
            ${inv.items.some(i => i.note) ? `<th>${t.note}</th>` : ""}
          </tr>
        </thead>
        <tbody> 
          ${inv.items.map((it, i) => `
            <tr>
              ...
              ${inv.items.some(x => x.note) ? `<td>${it.note || ""}</td>` : ""}
            </tr>
          `).join("")} 
        </tbody>
      </table>
    ...
    <div>
      ...
      {showForm && (
        <div style={{ background: s.bgCard, border: `1px solid ${PRIMARY}40`, borderRadius: 10, padding: 14, marginBottom: 10 }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 8, marginBottom: 10 }}>
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>DATE</label>
              <input 
                type="date" 
                value={form.date} 
                onChange={e => setForm({ ...form, date: e.target.value })} 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>INVOICE #</label>
              <input 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.currency}</label>
              <select 
                value={form.currency} 
                onChange={e => setForm({ ...form, currency: e.target.value })} 
                style={{ 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>BILL TO</label>
              <input 
                value={form.billTo} 
            ...
            <div>
              <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>Phone</label>
              <input 
                value={form.billPhone} 
                onChange={e => setForm({ ...form, billPhone: e.target.value })} 
                style={{ 
                  width: "100%", padding: "6px 10px", borderRadius: 6, 
                  border: `1px solid ${s.border}`, background: s.bgCard2, 
                  color: s.text, fontSize: 12 
          ...
          {form.items.map((item, i) => (
            <div 
              ...
              style={{ 
                ...
                gap: 5, marginBottom: 5, alignItems: "flex-end" 
              }}
            >
              <div>
                {i === 0 && <label style={{ fontSize: 10, color: s.textMuted }}>{t.itemName}</label>}
                <input 
                  value={item.name} 
                  ...
                  style={{ 
                    ...
                    border: `1px solid ${s.border}`, background: s.bgCard2, 
                    color: s.text, fontSize: 11 
                  }} 
                />
              </div>
              <div>
                {i === 0 && <label style={{ fontSize: 10, color: s.textMuted }}>{t.qty}</label>}
                <input 
                  type="number" 
                  value={item.qty} 
              ...
              <div>
                {i === 0 && <label style={{ fontSize: 10, color: s.textMuted }}>{t.price}</label>}
                <input 
                  type="number" 
                  value={item.price} 
              ...
              <div>
                {i === 0 && <label style={{ fontSize: 10, color: s.textMuted }}>{t.note}</label>}
                <input 
                  value={item.note} 
          ...
          <button 
            onClick={addItem} 
            style={{ 
              padding: "4px 10px", borderRadius: 5, border: `1px solid ${s.border}`, 
              background: s.bgCard2, color: s.text, fontSize: 10, 
          ...
          <div style={{ padding: "8px 12px", background: `${PRIMARY}10`, borderRadius: 6, textAlign: "right", marginBottom: 8 }}>
            <span style={{ fontWeight: 800, color: PRIMARY, fontSize: 15 }}>
              {t.total}: {form.currency === "usd" ? "$" : ""}{fmt(total)} {form.currency === "usd" ? t.usd : t.iqd}
            </span>
          </div>
      ...
      <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 10, overflow: "hidden" }}>
        <div style={{ overflowX: "auto" }}>
          <table style={tableStyle}>
            <thead>
              <tr>
                {["DATE", "INVOICE #", t.billTo, t.total, ""].map((h, i) => <TH key={i} isRtl={isRtl}>{h}</TH>)}
              </tr>
            </thead>
            <tbody>
              {invoices.map(inv => (
      ...
      {preview && (
        ...
        >
          <div 
            style={{ 
              background: "#fff", color: "#000", borderRadius: 10, padding: 30, 
          ...
          >
              ...
              <tbody>
                {preview.items.map((it, i) => (
                  <tr key={i} style={{ borderBottom: "1px solid #ddd", textAlign: "right" }}>
                    ...
                    <td style={{ padding: 5 }}>
                      <span style={{ direction: "ltr", display: "inline-block" }}>
                        {preview.currency === "usd" ? "$" : ""}{fmt(it.price)}
                      </span>
                    </td>
                    <td style={{ padding: 5, fontWeight: 600 }}>
                      <span style={{ direction: "ltr", display: "inline-block" }}>
            ...
            <div style={{ textAlign: "right", marginTop: 16 }}>
              <button 
                ...
                style={{ 
                  padding: "6px 20px", borderRadius: 6, border: "1px solid #ddd", 
                  background: "#f5f5f5", color: "#333", cursor: "pointer", fontSize: 12 
                }}
              >
                {t.cancel}
              </button>
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px,1fr))", gap: 14 }}>
        <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 12, padding: 24, textAlign: "center" }}>
          <I.Download />
          <h3 style={{ margin: "10px 0 6px", fontWeight: 700, fontSize: 14 }}>{t.downloadBackup}</h3>
          <button 
            onClick={handleDownload} 
            style={{ 
              padding: "8px 20px", borderRadius: 6, background: PRIMARY, 
        ...
        <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 12, padding: 24, textAlign: "center" }}>
          <I.Upload />
          <h3 style={{ margin: "10px 0 6px", fontWeight: 700, fontSize: 14 }}>{t.uploadBackup}</h3>
          <label 
            style={{ 
              display: "inline-flex", alignItems: "center", gap: 4, 
              padding: "8px 20px", borderRadius: 6, background: PRIMARY, 
    ...
    <div>
      ...
      <div style={{ background: s.bgCard, border: `1px solid ${s.border}`, borderRadius: 10, overflow: "hidden" }}>
        <div style={{ overflowX: "auto", maxHeight: 450, overflowY: "auto" }}>
          ...
          {recent.length === 0 && (
            <div style={{ padding: 30, textAlign: "center", color: s.textMuted, fontSize: 12 }}>
              {t.noData}
            </div>
          )}
        </div>
...
function MonthlyPage({ t, s, isRtl, pKey, cashIQD, cashUSD, exchangeRate }) {
  ...
  const doExport = (type, size) => {
    ...
    if (type === "pdf") {
      doPrint({ 
        title: `${t.sidebar.monthlyReport} ${dateFrom} - ${dateTo}`, 
        headers: hdrs, rows, size, isRtl 
      });
    } else {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 14, flexWrap: "wrap", alignItems: "flex-end" }}>
        <div>
          <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.from}</label>
          <input 
            type="date" 
            value={dateFrom} 
        ...
        <div>
          <label style={{ fontSize: 10, color: s.textMuted, fontWeight: 600 }}>{t.to}</label>
          <input 
            type="date" 
            value={dateTo} 
